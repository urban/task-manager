...
const renderBullets = (items: ReadonlyArray<string>): ReadonlyArray<string> =>
...
interface CompletionResultInput {
  readonly summary: string;
  readonly details: string;
  readonly decisions: ReadonlyArray<string>;
  readonly verification: ReadonlyArray<string>;
...
const resolveCompletionResultInput = Effect.fnUntraced(function* (input: {
