...
- The superseded architecture and verification checklist do not remain parallel implementation authorities after the approved pack has passed its final coverage and consistency checks.
...
- SC1.1: The approved pack accounts for every substantive obligation in `specs/lean-v1.md` and `specs/lean-v1-verification-checklist.md` with no unexplained omission or contradiction before those files are removed.
